...
<div class="">
  <div class="my-[40px] border border-solid border-bottom border-[#E2E8ED] h-[1px]"></div>
    <img class="w-full" src="<?= get_template_directory_uri();?>/assets/image/blog/article-start.svg" alt="Model - Forecast - Plan">
    <div class="text-[#2D3646] leading-[28px] text-[18px] font-semibold text-center mt-[21px]">Start Brixx 7 days trial</div>
    <a href="https://app.brixx.com/sign-up/trial?utm_source=split_test&amp;utm_campaign=headercta" class=" mt-[23px] block">
