         ...
         */ !(function (t, n) {
            ...
            var C =
                ...
                (function (e) {
                    ...
                    try {
                        P.apply((L = N.call(x.childNodes)), x.childNodes), L[x.childNodes.length].nodeType;
                    } catch (e) {
                        P = {
                            apply: L.length
                                ? function (e, t) {
                    ...
                    function ae(e, t, i, o) {
                        ...
                        if (!o && (p(t), (t = t || f), v)) {
                            ...
                            if (n.qsa && !$[e + " "] && (!g || !g.test(e)) && (1 !== x || "object" !== t.nodeName.toLowerCase())) {
                                if (((y = e), (m = t), 1 === x && (U.test(e) || F.test(e)))) {
                                          ...
                                          if (g) {
                                              ...
                                              if (((h = [s ? g.firstChild : g.lastChild]), s && m)) {
                                                  ...
                                                  for (
                                                      ;
                                                      (p = (++f && p && p[v]) || (b = f = 0) || h.pop()) &&
                                                      ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++b || (m && ((d = (u = p[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] = [T, b]), p !== t));
                            ...
                            ce(function (r, s, a, l) {
                                ...
                                if (r) {
                                    if (o || e) {
                                        ...
                                        for (d = y.length; d--; ) (u = y[d]) && (c = o ? H(r, u) : p[d]) > -1 && (r[c] = !(s[c] = u));
                                    }
                    ...
                    return (
                        ...
                        (s = ae.tokenize = function (e, t) {
                            ...
                            for (a = e, l = [], c = i.preFilter; a; ) {
                                ...
                                (n = !1),
                                (o = F.exec(a)) && ((n = o.shift()), r.push({ value: n, type: o[0].replace(W, " ") }), (a = a.slice(n.length))),
                                i.filter))
                                        ...
                                        var n = t.length > 0,
                                            ...
                                            r = function (r, s, a, l, d) {
                                                ...
                                                if (((y += m), n && m !== y)) {
                                                    ...
                                                    P.apply(l, w), d && !r && w.length > 0 && y + t.length > 1 && ae.uniqueSort(l);
                                                }
                                                return d && ((T = S), (c = x)), b;
                                            };
                                        return n ? ce(r) : r;
                ...
                k.each(
                    ...
                    function (e, t) {
                        k.fn[e] = function (n, i) {
                            ...
                            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = k.filter(i, o)), this.length > 1 && (H[e] || k.uniqueSort(o), N.test(e) && o.reverse()), this.pushStack(o);
                        };
                    }
                );
            var q = /[^\x20\t\r\n\f]+/g;
                        ...
                        var t = [
                            ...
                            o = {
                                ...
                                then: function (e, i, o) {
                                                ...
                                                d = o
                                                    ...
                                                    : function () {
                                                          try {
                                                              ...
                                                              k.Deferred.exceptionHook && k.Deferred.exceptionHook(n, d.stackTrace), e + 1 >= r && (i !== I && ((a = void 0), (l = [n])), t.rejectWith(a, l));
                                                          }
                                                      };
                                    ...
                                    return k
                                        .Deferred(function (n) {
                                            t[0][3].add(s(0, n, y(o) ? o : _, n.notifyWith)), t[1][3].add(s(0, n, y(e) ? e : _)), t[2][3].add(s(0, n, y(i) ? i : I));
                                        })
                                        .promise();
                                },
                                promise: function (e) {
            ...
            (k.fn.ready = function (e) {
                ...
                (k.ready.then = W.then),
                "complete" === b.readyState || ("loading" !== b.readyState && !b.documentElement.doScroll) ? n.setTimeout(k.ready) : (b.addEventListener("DOMContentLoaded", B), n.addEventListener("load", B));
            var F = function (e, t, n, i, o, r, s) {
                    var a = 0,
                        l = e.length,
                        c = null == n;
                    if ("object" === T(n)) for (a in ((o = !0), n)) F(e, t, a, n[a], !0, r, s);
                    else if (
                        void 0 !== i &&
                        ((o = !0),
                        y(i) || (s = !0),
                ...
                for (var r, s, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++)
                    if ((r = e[f]) || 0 === r)
                        if ("object" === T(r)) k.merge(p, r.nodeType ? [r] : r);
                            ...
                            for (s = s || u.appendChild(t.createElement("div")), a = (ge.exec(r) || ["", ""])[1].toLowerCase(), l = me[a] || me._default, s.innerHTML = l[1] + k.htmlPrefilter(r) + l[2], d = l[0]; d--; ) s = s.lastChild;
                            k.merge(p, s.childNodes), ((s = u.firstChild).textContent = "");
                        } else p.push(t.createTextNode(r));
                for (u.textContent = "", f = 0; (r = p[f++]); )
                    if (i && k.inArray(r, i) > -1) o && o.push(r);
                    else if (((c = se(r)), (s = be(u.appendChild(r), "script")), c && we(s), n)) for (d = 0; (r = s[d++]); ) ye.test(r.type || "") && n.push(r);
                return u;
            }
            var ke = /^([^.]*)(?:\.(.+)|)/;
            function Se() {
            ...
            (k.event = {
                        ...
                        for (
                            ...
                            (f = v = (a = ke.exec(t[c]) || [])[1]),
                                ...
                                f &&
                                    ...
                                    (u = k.event.special[f] || {}),
                                    (d = k.extend({ type: f, origType: v, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && k.expr.match.needsContext.test(o), namespace: h.join(".") }, r)),
                ...
                special: {
                    ...
                    click: {
                        setup: function (e) {
                            var t = this || e;
                            return ve.test(t.type) && t.click && O(t, "input") && Ee(t, "click", Se), !1;
                        },
                        trigger: function (e) {
                            var t = this || e;
                            return ve.test(t.type) && t.click && O(t, "input") && Ee(t, "click"), !0;
                        },
                        _default: function (e) {
                            var t = e.target;
            ...
            function qe(e, t, n, i) {
                ...
                if (p && ((r = (o = Te(t, e[0].ownerDocument, !1, e, i)).firstChild), 1 === o.childNodes.length && (o = r), r || i)) {
                    for (a = (s = k.map(be(o, "script"), Pe)).length; u < p; u++) (c = o), u !== f && ((c = k.clone(c, !0, !0)), a && k.merge(s, be(c, "script"))), n.call(e[u], c, u);
                    if (a)
                        for (d = s[s.length - 1].ownerDocument, k.map(s, Ne), u = 0; u < a; u++)
                            (c = s[u]),
                                ye.test(c.type || "") &&
                                    ...
                                    k.contains(d, c) &&
                                    (c.src && "module" !== (c.type || "").toLowerCase() ? k._evalUrl && !c.noModule && k._evalUrl(c.src, { nonce: c.nonce || c.getAttribute("nonce") }, d) : x(c.textContent.replace(De, ""), c, d));
                }
                return e;
            }
            function _e(e, t, n) {
            ...
            k.extend({
                ...
                clone: function (e, t, n) {
                    var i,
                        ...
                        a = e.cloneNode(!0),
                        l = se(e);
                    if (!(g.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || k.isXMLDoc(e))) for (s = be(a), i = 0, o = (r = be(e)).length; i < o; i++) Me(r[i], s[i]);
                    if (t)
                        if (n) for (r = r || be(e), s = s || be(a), i = 0, o = r.length; i < o; i++) He(r[i], s[i]);
                        else He(e, a);
            ...
            function Ue(e, t, n) {
                ...
                return (
                    (n = n || Re(e)) &&
                        ...
                        !g.pixelBoxStyles() && Ie.test(s) && Be.test(t) && ((i = l.width), (o = l.minWidth), (r = l.maxWidth), (l.minWidth = l.maxWidth = l.width = s), (s = n.width), (l.width = i), (l.minWidth = o), (l.maxWidth = r))),
                    void 0 !== s ? s + "" : s
                );
            }
            function Xe(e, t) {
            ...
            function nt(e, t, n) {
                ...
                return (
                    ((!g.boxSizingReliable() && o) || (!g.reliableTrDimensions() && O(e, "tr")) || "auto" === s || (!parseFloat(s) && "inline" === k.css(e, "display", !1, i))) &&
                        ...
                        return F(
                            ...
                            function (e, t, n) {
                                var i,
                                    ...
                                    s = 0;
                                if (Array.isArray(t)) {
                                    for (i = Re(e), o = t.length; s < o; s++) r[t[s]] = k.css(e, t[s], !1, i);
                                    return r;
                                }
            ...
            function pt(e, t, n) {
                ...
                for (
                    ...
                    if ((i = pt.prefilters[r].call(c, e, d, c.opts))) return y(i.stop) && (k._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
                return (
                    k.map(d, ut, c),
                    ...
                    attr: function (e, t, n) {
                        ...
                        if (3 !== r && 8 !== r && 2 !== r)
                            return void 0 === e.getAttribute
                                ? k.prop(e, t, n)
                                : ((1 === r && k.isXMLDoc(e)) || (o = k.attrHooks[t.toLowerCase()] || (k.expr.match.bool.test(t) ? ft : void 0)),
                                  void 0 !== n
                                      ? null === n
                ...
                k.fn.extend({
                    addClass: function (e) {
                        ...
                        return y(e)
                            ...
                            : (t = bt(e)).length
                            ? this.each(function () {
                                  if (((i = mt(this)), (n = 1 === this.nodeType && " " + yt(i) + " "))) {
                        ...
                        return y(e)
                            ...
                            : ((n = bt(e)),
                              this.each(function () {
                                  ...
                                  else (void 0 !== e && "boolean" !== s) || ((i = mt(this)) && J.set(this, "__className__", i), this.setAttribute && this.setAttribute("class", i || !1 === e ? "" : J.get(this, "__className__") || ""));
                              }));
                    },
                    hasClass: function (e) {
                        var t,
            ...
            k.extend(k.event, {
                trigger: function (e, t, i, o) {
                    ...
                    if (
                        ...
                        if (!o && !u.noBubble && !m(i)) {
                            for (l = u.delegateType || v, xt.test(l + v) || (s = s.parentNode); s; s = s.parentNode) h.push(s), (a = s);
                ...
                k.fn.extend({
                    ...
                    serializeArray: function () {
                        return this.map(function () {
                            ...
                            .filter(function () {
                                var e = this.type;
                                return this.name && !k(this).is(":disabled") && Ot.test(this.nodeName) && !Et.test(e) && (this.checked || !ve.test(e));
                            })
                            .map(function (e, t) {
                                var n = k(this).val();
                                return null == n
            ...
            (zt.href = kt.href),
                k.extend({
                    ...
                    ajax: function (e, t) {
                        ...
                        if ((f.data && f.processData && "string" != typeof f.data && (f.data = k.param(f.data, f.traditional)), Wt(qt, f, t, S), c)) return S;
                        ...
                        f.hasContent
                            ...
                            : ((p = f.url.slice(o.length)),
                              ...
                              !1 === f.cache && ((o = o.replace(Pt, "$1")), (p = (Ct.test(o) ? "&" : "?") + "_=" + St.guid++ + p)),
                              (f.url = o + p)),
                        ...
                        S.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + It + "; q=0.01" : "") : f.accepts["*"]),
                        f.headers))
                            S.setRequestHeader(u, f.headers[u]);
                        if (f.beforeSend && (!1 === f.beforeSend.call(h, S, f) || c)) return S.abort();
                        if (((T = "abort"), y.add(f.complete), S.done(f.success), S.fail(f.error), (i = Wt(_t, f, t, S)))) {
                        ...
                        function C(e, t, s, l) {
                            ...
                            c ||
                                ...
                                (S.status = e),
                                (S.statusText = (t || T) + ""),
                                u ? g.resolveWith(h, [p, T, S]) : g.rejectWith(h, [S, T, b]),
                                S.statusCode(m),
                                (m = void 0),
                                d && v.trigger(u ? "ajaxSuccess" : "ajaxError", [S, f, u ? p : b]),
                                y.fireWith(h, [S, T]),
            ...
            k.ajaxSetup({
                ...
                (k.parseHTML = function (e, t, n) {
                    return "string" != typeof e
                        ...
                        : ("boolean" == typeof t && ((n = t), (t = !1)),
                          ...
                          (r = !n && []),
                          (o = L.exec(e)) ? [t.createElement(o[1])] : ((o = Te([e], t, r)), r && r.length && k(r).remove(), k.merge([], o.childNodes)));
                    var i, o, r;
                }),
                ...
                k.each(["top", "left"], function (e, t) {
                    k.cssHooks[t] = Xe(g.pixelPosition, function (e, n) {
                        if (n) return (n = Ue(e, t)), Ie.test(n) ? k(e).position()[t] + "px" : n;
                    });
                }),
        ...
        !(function (e, t) {
            ...
            function r(t, i, r, s, a) {
                        ...
                        (i.delay < 0 || i.combined) &&
                            ((s.e =
                                ...
                                function (e, n) {
                                    ...
                                    p && clearTimeout(p), r > o || !i.enableThrottle || n ? s() : (p = setTimeout(s, o - r));
                                })),
                            (s.a = function (e) {
                                (e = f(e)), r.push.apply(r, e);
                            }),
                            (s.g = function () {
                            ...
                            h(),
                            n(i.appendScroll).on("scroll." + a + " resize." + a, s.e));
                }
                function f(e) {
                    for (
                        var o = i.defaultImage,
                            ...
                            u = (e = n(e)
                                ...
                                .data("plugin_" + i.name, t)).length;
                        d < u;
                        d++
                    ) {
                        var p = n(e[d]),
                            f = y(e[d]),
                            h = p.attr(i.imageBaseAttribute) || s;
                        "img" === f && h && p.attr(a) && p.attr(a, m(p.attr(a), h)),
                            void 0 === c[f] || p.attr(l) || p.attr(l, c[f]),
                            "img" === f && o && !p.attr("src") ? p.attr("src", o) : "img" === f || !r || (p.css("background-image") && "none" !== p.css("background-image")) || p.css("background-image", "url('" + r + "')");
                    }
                    return e;
                }
                function h(e, o) {
                    if (r.length) {
                        for (var s = o || r, a = !1, l = i.imageBase || "", c = i.srcsetAttribute, d = i.handledName, u = 0; u < s.length; u++)
                            if (e || o || g(s[u])) {
                                var p = n(s[u]),
                                    f = y(s[u]),
                                    h = p.attr(i.attribute),
                                    m = p.attr(i.imageBaseAttribute) || l,
                                    b = p.attr(i.loaderAttribute);
                                p.data(d) ||
                                    (i.visibleOnly && !p.is(":visible")) ||
                                    !(((h || p.attr(c)) && (("img" === f && (m + h !== p.attr("src") || p.attr(c) !== p.attr("srcset"))) || ("img" !== f && m + h !== p.css("background-image")))) || b) ||
                                    ((a = !0), p.data(d, !0), v(p, f, m, b));
                            }
                        a &&
                ...
                function v(e, t, o, r) {
                    ...
                    if (r) {
                        var g = function () {
                            f && e.removeAttr(i.loaderAttribute), e.data(h, !0), w("afterLoad", e), setTimeout(b, 1), (g = n.noop);
                        };
                        e.off("error").one("error", s).one("load", g),
                            w(r, e, function (t) {
                                t ? (e.off("load"), g()) : (e.off("error"), s());
                            }) || e.trigger("error");
                    } else {
                        var y = n(new Image());
                        y.one("error", s).one("load", function () {
                            e.hide(),
                                "img" === t ? e.attr("sizes", y.attr("sizes")).attr("srcset", y.attr("srcset")).attr("src", y.attr("src")) : e.css("background-image", "url('" + y.attr("src") + "')"),
                                e[i.effect](i.effectTime),
                                f && (e.removeAttr(a + " " + c + " " + p + " " + i.imageBaseAttribute), "sizes" !== d && e.removeAttr(d)),
                                e.data(h, !0),
                                w("afterLoad", e),
                                y.remove(),
                                b();
                        });
                        var m = (u && v ? v : e.attr(a)) || "";
                        y
                            .attr("sizes", e.attr(d))
                            .attr("srcset", e.attr(c))
                            .attr("src", m ? o + m : null),
                            y.complete && y.trigger("load");
                    }
                }
                function g(t) {
                    var o = t.getBoundingClientRect(),
                        r = i.scrollDirection,
                        s = i.threshold,
                        a = (d >= 0 ? d : (d = n(e).height())) + s > o.top && -s < o.bottom,
                        l = (c >= 0 ? c : (c = n(e).width())) + s > o.left && -s < o.right;
                ...
                function b() {
                    --l, r.length || l || w("onFinishedAll");
                }
                function w(e, n, o) {
                    return !!(e = i[e]) && (e.apply(t, [].slice.call(arguments, 1)), !0);
                }
                "event" === i.bind || o ? p() : n(e).on("load." + a, p);
            }
            function s(t, o) {
                var s = this,
                    a = n.extend({}, s.config, o),
                    l = {},
                    c = a.name + "-" + ++i;
                return (
            ...
            (n.fn.Lazy = n.fn.lazy = function (e) {
                ...
                (n.Lazy = n.lazy = function (e, t, i) {
                    if ((n.isFunction(t) && ((i = t), (t = [])), n.isFunction(i))) {
                        ...
                        for (var o = s.prototype.config, r = o._f || (o._f = {}), a = 0, l = e.length; a < l; a++) (void 0 === o[e[a]] || n.isFunction(o[e[a]])) && (o[e[a]] = i);
                        for (var c = 0, d = t.length; c < d; c++) r[t[c]] = e[0];
                    }
                }),
                (s.prototype.config = {
    ...
    function (e, t, n) {
                ...
                (n = [
                    {
                        ...
                        value: function () {
                            ...
                            document.addEventListener("click", function (t) {
                                e.shouldModalClose(t) && e.closeModal(t);
                            }),
                                document.addEventListener("click", function (t) {
                                    e.constants.MODAL_CALLERS.forEach(function (e) {
                                        var n = t.target.closest(e.callerSelector);
                                        n && (t.preventDefault(), e.handlerFunction(n));
                                    });
                                });
                        },
                    },
                    {
                        ...
                        value: function (e) {
                            return this.constants.MODAL_CLOSE_SELECTORS.some(function (t) {
                    ...
                    },
                    {
                        key: "openModal",
                        value: function (e) {
                            this.$modal.classList.add(this.constants.MODAL_ACTIVE_CLASS), this.$modal.querySelector("#".concat(e)).classList.add(this.constants.MODAL_ITEM_ACTIVE_CLASS), (this.isModalOpened = !0);
                        },
                    },
                    {
                        key: "closeModal",
                        value: function (e) {
                            if (this.isModalOpened) {
                                ...
                                var t = this.$modal.querySelector(".".concat(this.constants.MODAL_ITEM_ACTIVE_CLASS));
                                t && t.classList.remove(this.constants.MODAL_ITEM_ACTIVE_CLASS), (this.isModalOpened = !1);
                            }
                        },
                    },
                ]) && i(t.prototype, n),
        ...
        var v = (function (e) {
            ...
            function r() {
                ...
                return (
                    ...
                    ((e = o.call(this)).constants = a(
                        a({}, e.constants),
                        {},
                        {
                            MODAL_CALLERS: [
                                { callerSelector: '[href^="#modal"]', handlerFunction: e.callModalDueToAnchor.bind(f(e)) },
                                { callerSelector: "[data-modal-id]", handlerFunction: e.callModalDueToDataAttr.bind(f(e)) },
                            ],
                        }
                    )),
                    e
                ...
                (n = [
                    {
                        ...
                        value: function () {
                            document.getElementById("modal-window")
                                ? (this.components = this.components.map(function (e) {
                                      return new e();
                                  }))
        ...
        var D = (function (e) {
                ...
                function r() {
                    ...
                    return (
                        ...
                        ((e = o.call(this)).constants = x(
                            x({}, e.constants),
                            {},
                            { MODAL_VIDEO_ID: "modal-video", MODAL_CALLERS: [{ callerSelector: "[data-video-src]", handlerFunction: e.callModalVideoHandler.bind(O(e)) }], MODAL_CALL_VIDEO_SELECTORS: "" }
                        )),
                        (e.$modalVideo = document.getElementById(e.constants.MODAL_VIDEO_ID)),
                        e
                    );
                }
                return (
                    ...
                    (n = [
                        {
                            ...
                            value: function (e) {
                                var t = e.dataset.videoSrc;
                                this.$modalVideo.querySelector("iframe").setAttribute("src", "".concat(t, "?autoplay=1")), this.openModal(this.constants.MODAL_VIDEO_ID);
                            },
                        },
                        {
                            key: "closeModal",
                            value: function (e) {
                                this.$modal.querySelector("#".concat(this.constants.MODAL_VIDEO_ID)).querySelector("iframe").setAttribute("src", ""), S(L(r.prototype), "closeModal", this).call(this, e);
                            },
                        },
                    ]) && k(t.prototype, n),
                    i && k(t, i),
            ...
            P = n.n(j);
        function N() {
            var e = document.querySelectorAll(".menu-trigger"),
                t = document.querySelector(".header__mobile-menu");
            e.forEach(function (e) {
                e.addEventListener("click", function () {
                    t.classList.toggle("nav-active"),
                        P()(".menu-trigger").hasClass("non-checked")
                            ? (P()("html").css({ overflow: "hidden", height: "100%" }), P()(".menu-trigger").addClass("checked"), P()(".menu-trigger").removeClass("non-checked"))
                            : (P()("html").css({ overflow: "auto", height: "auto" }), P()(".menu-trigger").removeClass("checked"), P()(".menu-trigger").addClass("non-checked"));
                });
            });
        }
        function H() {
        ...
        function _() {
            P()(window).on("load", function () {
                P()("body").removeClass("preload");
            }),
                document.querySelectorAll("[data-dropdown-status]").forEach(function (e) {
                    var t = e,
                        n = e.querySelector("[data-dropdown-head]"),
                        i = t.querySelector("[data-dropdown-body]");
                    n.addEventListener("click", function (e) {
                        var n = t.dataset.workingRange.split(" "),
                            o = n[0],
                            r = n[1] || 1 / 0;
                        window.innerWidth >= o &&
                            r >= window.innerWidth &&
                            ("open" === t.dataset.dropdownStatus ? ((t.dataset.dropdownStatus = "close"), t.classList.remove("active")) : ((t.dataset.dropdownStatus = "open"), t.classList.add("active")),
                            (function (e) {
                                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 500;
                                "none" === window.getComputedStyle(e).display ? q(e, t) : M(e, t);
                            })(i, 300));
                    });
                });
        }
            ...
            H(),
                ...
                document.querySelectorAll(".select").forEach(function (e) {
                    e.addEventListener("click", function (t) {
                        e.parentElement.classList.toggle("select-active");
                    }),
                        e.addEventListener(
                            "blur",
                            function (t) {
                                e.parentElement.classList.remove("select-active");
                            },
                            !0
                        );
                }),
...
/*
                (function () {
                    P()("button, :radio, select").on("change", function (e) {
						console.log("Get Active");
                        var t = document.querySelectorAll(".pricing-card__price-place");
                        document.querySelectorAll(".pricing-card__price-symbol").forEach(function (e) {
                            var t = P()("input[name=currency]:checked").data("symbol");
                            e.innerHTML = t;
                        }),
                            t.forEach(function (e) {
                                var t = P()("input[name=monthly-annually]:checked").data("month-annual"),
                                    n = "data-" + P()("input[name=currency]:checked").data("currency") + "-" + t,
                                    i = e.closest(".pricing-card"),
                                    o = P()(i).attr(n);
                                ((e.innerText = o), null !== P()(".select").closest(".pricing-card")) && P()(".select").closest(".pricing-card").addClass("with-select");
                                if (P()(".pricing-card").hasClass("with-select")) {
                                    var r = document.querySelector(".with-select > .pricing-card__inner > .pricing-card__price > .pricing-card__price-place-wrap > .center-flex >.pricing-card__price-place"),
                                        s = n + "-value",
                                        a = P()("option[name=month-annual]:selected").attr(s);
                                    a && ((r.innerText = a), P()(".pricing-card__price-left").text(" "));
                                }
                            });
                    });
                    var e = 0,
                        t = P()(".pricing-card__price");
                    t.each(function () {
                        var t = P()(this).height();
                        t > e && (e = t);
                    }),
                        P()(window).width() > 767 && t.height(e);
                    var n = document.getElementById("pricing-inner");
                    P()("#monthly").change(function () {
                        n.classList.add("pricing--month"), n.classList.remove("pricing--annual");
                    }),
                        P()("#annually").change(function () {
                            n.classList.remove("pricing--month"), n.classList.add("pricing--annual");
                        });
                })(),
				$("#pricing-triggers").length &&
					$.ajax("https://ipapi.co/currency/", {
						success: function (e) {
							var t = $('input[name="currency"]');
							switch (e) {
								case "GBP":
									t.each(function (index, element) {
										"gbp" === $(element).data("currency") && $(element).parent().trigger("click");
									});
									break;
								case "EUR":
									t.each(function (index, element) {
										"eur" === $(element).data("currency") && $(element).parent().trigger("click");
									});
									break;
								case "CAD":
									t.each(function (index, element) {
										"cad" === $(element).data("currency") && $(element).parent().trigger("click");
									});
									break;
								case "AUD":
									t.each(function (index, element) {
										"aud" === $(element).data("currency") && $(element).parent().trigger("click");
									});
									break;
								default:
									setDefaultCurrencyToUSD(t);
							}
						},
						error: function() {
							var t = $('input[name="currency"]');
				...
				function setDefaultCurrencyToUSD(t) {
					t.each(function (index, element) {
						if ("usd" === $(element).data("currency")) {
...
//NEW START
    (function () {
        function updatePricing() {
            console.log("Get Active");
            var pricePlaces = document.querySelectorAll(".pricing-card__price-place");
            var priceSymbols = document.querySelectorAll(".pricing-card__price-symbol");

            priceSymbols.forEach(function (e) {
                var symbol = P()("input[name=currency]:checked").data("symbol");
                e.innerHTML = symbol;
            });

            pricePlaces.forEach(function (e) {
                var period = P()("input[name=monthly-annually]:checked").data("month-annual"),
                    attribute = "data-" + P()("input[name=currency]:checked").data("currency") + "-" + period,
                    card = e.closest(".pricing-card"),
                    price = P()(card).attr(attribute);
                e.innerText = price;

                var selectCard = P()(".select").closest(".pricing-card");
                if (selectCard.length) {
                    selectCard.addClass("with-select");
                }

                var withSelectCard = P()(".pricing-card.with-select");
                if (withSelectCard.length) {
                    var r = withSelectCard.find(".pricing-card__price-place-wrap .center-flex .pricing-card__price-place"),
                        valueAttr = attribute + "-value",
                        optionValue = P()("option[name=month-annual]:selected").attr(valueAttr);
                    if (optionValue) {
                        r.text(optionValue);
                        P()(".pricing-card__price-left").text(" ");
                    }
                }

                // Remove price-loading class to show prices after updating
                e.classList.add("price-visible");
            });
        }

        function setInitialPricing() {
            var selectedCurrency = P()("input[name=currency]:checked");
            if (!selectedCurrency.length) {
                selectedCurrency = P()('input[name="currency"][data-currency="usd"]');
                selectedCurrency.prop("checked", true);
            }
            selectedCurrency.parent().trigger("click");

            var selectedPeriod = P()("input[name=monthly-annually]:checked");
            if (!selectedPeriod.length) {
                selectedPeriod = P()('#annually');
                selectedPeriod.prop("checked", true);
            }
            selectedPeriod.trigger("change");

            updatePricing();
        }

        P()("button, :radio, select").on("change", updatePricing);

        var maxHeight = 0,
            priceCards = P()(".pricing-card__price");
        priceCards.each(function () {
            var height = P()(this).height();
            if (height > maxHeight) {
                maxHeight = height;
            }
        });
        if (P()(window).width() > 767) {
            priceCards.height(maxHeight);
        }

        var pricingInner = document.getElementById("pricing-inner");
        P()("#monthly").change(function () {
            pricingInner.classList.add("pricing--month");
            pricingInner.classList.remove("pricing--annual");
        });
        P()("#annually").change(function () {
            pricingInner.classList.remove("pricing--month");
            pricingInner.classList.add("pricing--annual");
        });

        // Set initial pricing on DOM content load
        document.addEventListener("DOMContentLoaded", function () {
            setInitialPricing();
        });
    })();
...
//NEW END
                (function () {
                    var e = document.querySelectorAll("[data-tab-target]"),
                        t = document.querySelectorAll("[data-tab-content]");
                    e.forEach(function (n) {
                        n.addEventListener("click", function () {
                            var i = document.querySelector(n.dataset.tabTarget);
                            t.forEach(function (e) {
                ...
                (e = P()(".our-customers__wrapper")),
                (t = P()(".our-customers__item")),
                e.slick({
                    slidesToShow: 2,
                    slidesToScroll: 2,
                    dots: !0,
                    appendDots: P()(".our-customers__dots"),
                    prevArrow: P()(".our-customers__left"),
                    nextArrow: P()(".our-customers__right"),
                    infinite: !1,
                    adaptiveHeight: !0,
                    responsive: [{ breakpoint: 768, settings: { slidesToShow: 1, slidesToScroll: 1 } }],
                }),
                t.length <= 2 && P()(".our-customers__arrow").addClass("d-none"),
                (n = 1),
                (i = parseInt($('[name="maxPage"]').val())),
                (o = parseInt($('[name="maxPageNewQuery"]').val())),
                (r = $('[name="has_template_appender"]').length),
                $("[data-load-more]").on("click", function (e) {
                    e.preventDefault();
                    var t = $(".archive__foot"),
                        s = $('[name="query"]').val(),
                        a = { action: "blog_load_more", page: ++n, has_appender_template: r, maxPageNewQuery: o, query: s };
                    n <= i
                        ? $.ajax({
                              ...
                              success: function (e) {
                                  $("[data-archive-body]").append(e.html), t.removeClass("loading"), H(), n === i && t.addClass("hidden");
                              },
                          })
                        : t.addClass("hidden");
                }),
                (function () {
                    if (document.getElementById("find-more")) {
                        var e = document.getElementById("find-more");
                        document.addEventListener("change", function () {
                            e.classList.remove("d-none");
                            var t = $("option[data-link]:checked").data("link");
                            e.href = t;
                        });
                    }
                })(),
                window.addEventListener(
                    ...
                    function () {
                        ...
                        $("#download-trigger").on("click", function () {
                            e = $(this).data("file-url");
                            var t = $("[data-title-download]").html();
                            $("[data-modal-title]").html(t);
                        });
                        var t = document.querySelector("#wpcf7-f2406-o2");
                        t &&
                            t.addEventListener(
                                "wpcf7mailsent",
                                function (t) {
                ...
                (function () {
                    var e = $("iframe[data-src]");
                    e.length &&
                        setTimeout(function () {
                            e.each(function () {
                                var e = $(this).attr("data-src");
                                $(this).attr("src", e), $(this).parent().addClass("loaded");
                            });
                        }, 3e3);
                })(),
                (function () {
                    var e = 1,
                        t = $(".grid-of-advisors__foot");
                    $("[data-load-more-partnership]").on("click", function (n) {
                        n.preventDefault();
                        var i = parseInt($('[name="maxPage"]').val()),
                            o = $('[name="query"]').val(),
                            r = { action: "partnership_load_more", page: ++e, query: o };
                        e <= i
                            ? $.ajax({
                                  url: customjs_ajax_object.ajax_url,
                                  ...
                                  success: function (n) {
                                      $("[data-archive-body]").append(n.html), t.removeClass("loading"), H(), e === i && t.addClass("hidden");
                                  },
                              })
                            : t.addClass("hidden");
                    }),
                        $("[data-tax-filter]").on("click", function (n) {
                            n.preventDefault();
                            var i = $('[name="query"]').val(),
                                o = $('[name="industry-experience"]').val(),
                                r = $('[name="locations"]').val(),
                                s = $('[name="services-type"]').val();
                            e = 1;
                            var a = { action: "partnership_filter", query: i, industry: o, location: r, service: s };
                            $.ajax({
                                url: customjs_ajax_object.ajax_url,
                                data: a,
                                type: "POST",
                                ...
                                success: function (n) {
                                    $('[name="query"]').val(n.args),
                                        $('[name="maxPage"]').val(n.max_page),
                                        $("[data-archive-body]").html(n.html),
                                        t.removeClass("loading"),
                                        H(),
                                        e >= n.max_page ? t.addClass("hidden") : t.removeClass("hidden");
                                },
                            });
                        });
                })();
